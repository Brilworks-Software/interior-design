...
export const furnitureModels = {
  ...
  armchair:       { path: '/models/armchair.glb',      scale: [1.25, 1.25, 1.25], offset: [0, 0, 0] },
  ...
  bed:            { path: '/models/bed.glb',           scale: [0.075, 0.075, 0.075], offset: [0, 0, 0] },
  nightstand:     { path: '/models/nightstand.glb',    scale: [4, 4, 4], offset: [0, 0, 0] },
  'side-table':   { path: '/models/side-table.glb',    scale: [1.75, 1.75, 1.75], offset: [0, 0, 0] },
  wardrobe:       { path: '/models/wadrobe.glb',       scale: [0.13, 0.13, 0.13], offset: [0, 0, 0] },
  'floor-lamp':   { path: '/models/floor-lamp.glb',    scale: [2.5, 2.5, 2.5],       offset: [0, 0, 0] },
  'table-lamp':   { path: '/models/table-lamp.glb',    scale: [0.015, 0.015, 0.015], offset: [0, 0, 0] },
  rug:            { path: '/models/rug.glb',           scale: [0.05, 0.05, 0.05], offset: [0, 0, 0] },
  plant:          { path: '/models/plant.glb',         scale: [4, 4, 4],       offset: [0, 0, 0] },
}
