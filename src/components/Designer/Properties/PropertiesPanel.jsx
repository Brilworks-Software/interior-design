      ...
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            {catalogItem?.name ?? obj.furnitureId}
          </p>
        </div>
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-primary0 hover:bg-primary rounded transition-colors"
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
        ...
        <div>
              ...
              <button
                ...
                className={`flex-1 py-1.5 text-xs rounded transition-colors ${
                  obj.rotation === deg
                    ...
                    : "bg-gray-100 text-gray-600 hover:bg-primary hover:text-secondary"
                }`}
              >
                {deg}°
              </button>
          ...
          <input
            ...
            onPointerUp={() =>
              updateObject(obj.id, { rotation: rotDraftRef.current })
            }
        ...
        <div>
          ...
          <input
            ...
            onPointerUp={() =>
              updateObject(obj.id, { scale: scaleDraftRef.current })
            }
            className="w-full accent-primary0"
          />
          <div className="flex justify-between mt-1">
            <span className="text-xs text-gray-400">
              {catalogItem?.minScale ?? 0.5}x
            </span>
            <button
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Drag the object in the viewport to reposition
          </p>
        </div>
      </div>
    </div>
